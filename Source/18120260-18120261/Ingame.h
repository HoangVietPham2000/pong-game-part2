...
public:
	...
	void moveComBar();//di chuyen thanh cua may'
	void drawFood(); //ve do an
	void deleteFood(int x); // xoa do an
	int checkFood(); //kiem tra xem bong co cham do an hay khong
	int findBallP1();
	void printCup();
};
#endif
